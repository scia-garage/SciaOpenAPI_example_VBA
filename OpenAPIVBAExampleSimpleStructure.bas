...
Public Function OpenApiExample() As Integer
  ...
  SENpath = "c:\WORK\SCIA-ENGINEER\TESTING-VERSIONS\Full_99.01201.009.64_integration.testing_x64\"
  
  Dim templ As String
  templ = "C:\Users\jbroz\OneDrive - SCIA nv\WORK\SCIA-ENGINEER\TESTING-PROJECTS\QuickTests\OpenAPIEmptyProject.esa"
...
'  Debug.Print templ
  ...
  Call env.Init(SENpath, ".\tmp", "99.01201.009.64")
 ...
 ' Debug.Print "SEn started"
  ...
  conmat.Name = "Concrete" 'Sheets("Sheet1").Cells(4, 2).Value
  conmat.Type = 0
  conmat.Quality = Sheets("Sheet1").Cells(4, 2).Value
  ...
  stmat.Name = "Steel" 'Sheets("Sheet1").Cells(5, 2)
  stmat.Type = 1
  stmat.Quality = Sheets("Sheet1").Cells(5, 2).Value
  ...
  Set css.ID = cssid
  css.Name = "css"
  css.Profile = Sheets("Sheet1").Cells(6, 2).Value
  css.FormCode = 1
  css.DescriptionId = 0
  ...
  Set n2.ID = n2id
  n2.Name = "N2"
  n2.X = Sheets("Sheet1").Cells(1, 2) 'a
  n2.Y = 0
  n2.Z = 0
  ...
  Set n3.ID = n3id
  n3.Name = "N3"
  n3.X = Sheets("Sheet1").Cells(1, 2) 'a
  n3.Y = Sheets("Sheet1").Cells(2, 2) 'b
  n3.Z = 0#
  ...
  n4.Name = "N4"
  n4.X = 0
  n4.Y = Sheets("Sheet1").Cells(2, 2) 'b
  n4.Z = 0
  ...
  n5.X = 0#
  n5.Y = 0#
  n5.Z = Sheets("Sheet1").Cells(3, 2) 'c
  ...
  Set n6.ID = n6id
  n6.Name = "N6"
  n6.X = Sheets("Sheet1").Cells(1, 2) 'a
  n6.Y = 0 'b
  n6.Z = Sheets("Sheet1").Cells(3, 2) 'c
  ...
  Set n7.ID = n7id
  n7.Name = "N7"
  n7.X = Sheets("Sheet1").Cells(1, 2) 'a
  n7.Y = Sheets("Sheet1").Cells(2, 2) 'b
  n7.Z = Sheets("Sheet1").Cells(3, 2) 'c
  ...
  n8.Name = "N8"
  n8.X = 0
  n8.Y = Sheets("Sheet1").Cells(2, 2) 'b
  n8.Z = Sheets("Sheet1").Cells(3, 2) 'c
  ...
  s1.Thickness = Sheets("Sheet1").Cells(7, 2).Value
  s1.Type = 0
  ...
  sl1.Value = Sheets("Sheet1").Cells(8, 2).Value
...
'
 ...
 Do While i < rintf.GetMeshElementCount()
  Sheets("Sheet2").Cells(i + 3, j + 1) = i + 1
    Do While j < rintf.GetMagnitudesCount()
    Sheets("Sheet2").Cells(i + 3, j + 2) = rintf.GetValue(j, i)
    j = j + 1
  Loop
  i = i + 1
  j = 0
...
Do While i < defSlabRes.GetMeshElementCount()
    Sheets("Sheet2").Cells(i + 18, j + 1) = i + 1
    Do While j < defSlabRes.GetMagnitudesCount()
      Sheets("Sheet2").Cells(i + 18, j + 2) = defSlabRes.GetValue(j, i)
    j = j + 1
  Loop
  i = i + 1
  j = 0
